  ...
  api.adiciona = (req,res)=>{
      ...
      const header =function(){
        return{
      			...
      			table: {
      				...
      				body: [
      				    [ {rowSpan:2, image: 'logo', width:'100'}, {text: 'PMO_IMPLANTAÇÃO', alignment: 'center'},{text: 'Data: '+moment().format('L'), style: 'tableHeader', alignment: 'center'}],
    ...
    footerLinha.push(footer,{},{},{text:formulario.ittotal,border: [false, true, true, true],style:'tableTitle',alignment:'left'})
          ...
          return lista
				...
				function listaDeEnvolvidos(){
				    let lista = [];
				    let novaLinha = [];
				    let t1 = {text:'AREAS DA EMPRESA A SEREM ENVOLVIDA',style:'tableTitle',alignment:'center'};
				    let t2 = {text:'VISTO',style:'tableTitle',alignment:'center'};
				    novaLinha.push(t1,t2)
				    lista.push(novaLinha);
				    for(var i=0; formulario.areasEnvolvidas.length >i; i++){
				        let novaLinha = [];
				        let b1 = {text:formulario.areasEnvolvidas[i]}
				        let b2 = {}
				        novaLinha.push(b1,b2);
				        lista.push(novaLinha);
				    }
				...
				const solicitanteChange = function(){
					if(formulario.solicitante == "Outros"){
						return formulario.solicitanteOutros;
					}else{
						return formulario.solicitante;
					}
				}
        ...
        header(),
    		{
    		    table:{
    		        ...
    		        body:[
    		            ...
    		            [{text:"Solicitante: ",style:'tableTitle'},{text:solicitanteChange()}],
        ...
        header(),
        {
          table:{
            ...
            body:[
                ...
                ['Valor Instal',{text:'R$:'+formulario.precificacao.valorInstalacao},{text:'',border: [false, false, false, false]},'CET',{text:formulario.cet}],
